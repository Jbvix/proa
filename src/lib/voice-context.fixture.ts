...
export function ctx(over: Partial<VoiceContext> = {}): VoiceContext {
  return {
    ...
    posicao: { lat: -3.71234, lon: -38.54321, latLon: "", costa: "", costaNome: "", costaNm: 12, portoNm: 8, rumoDeg: 310.4, rumo: "310° NO", sogKn: 7.24, sogValidacao: "gps", xteNm: 0.041, xteLado: "linha" },
    waypoints: [
      { nome: "Mucuripe", nm: 2, faltaNm: 0.1, eta: null, hsPrev: null },
      { nome: "WP meio", nm: 18, faltaNm: 7.96, eta: "15:10", hsPrev: 1.1 },
    ],
    cidades: [],
    mar: { hsCasco: 0.83, ampM: 0.4, tzS: 5.2, ondasMin: 12, estado: "Fraco", confiavel: true, hsPrev: 1.12, tzPrev: 6, swellPrev: 0.6, balancoDeg: 4.2 },
